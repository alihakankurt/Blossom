...
public sealed class BloomNode : IAsyncDisposable
{
    ...
    private readonly BloomConfig _configuration;
    ...
    public BloomNode(DiscordSocketClient discordClient, BloomConfig configuration)
    {
    ...
    public bool TryGetPlayer(IGuild guild, [NotNullWhen(true)] out BloomPlayer player)
    {
